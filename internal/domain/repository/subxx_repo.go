...
// type SubscriptionXXRepository struct {
// 	db *gorm.DB
// }

// func NewSubscriptionXXRepository(db *gorm.DB) *SubscriptionXXRepository {
// 	return &SubscriptionXXRepository{
// 		db: db,
// 	}
// }

// type ISubscriptionXXRepository interface {
...
// func (r *SubscriptionXXRepository) GetCountRetrySub(serviceId int, msisdn string) (int, error) {
// 	var count int
...
// func (r *SubscriptionXXRepository) GetCountSub(serviceId int, msisdn string) (int, error) {
// 	var count int
...
// func (r *SubscriptionXXRepository) GetCountActiveSub(serviceId int, msisdn string) (int, error) {
// 	var count int
